...
var tour = require('./app/route/tour.route.js');
tour(app);

var sale = require('./app/route/sale.route.js');
sale(app);

var tour_img = require('./app/route/tour_img.route.js');
tour_img(app);

var ticket = require('./app/route/ticket.route.js');
ticket(app);

var review = require('./app/route/review.route.js');
review(app);
