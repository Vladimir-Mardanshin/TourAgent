var dbProperties = {
    database: 'TurAgent', // название базы данных
...
db.sale = require('../model/sale.model.js')(sequelize, Sequelize);
db.tour = require('../model/tour.model.js')(sequelize, Sequelize);
db.tour_img = require('../model/tour_img.model.js')(sequelize, Sequelize);
